...
class ApiResource(BaseModel):
    ...
    categories: Optional[List[str]] = Field(
        None, description="categories is a list of the grouped resources this resource belongs to (e.g. 'all')"
    )
    ...
    namespaced: bool = Field(..., description='namespaced indicates if a resource is namespaced or not.')
    short_names: Optional[List[str]] = Field(
        None, alias='shortNames', description='shortNames is a list of suggested short names of the resource.'
    )
...
class ApiResourceList(BaseModel):
    ...
    group_version: str = Field(
        ..., alias='groupVersion', description='groupVersion is the group and version this APIResourceList is for.'
    )
...
class Preconditions(BaseModel):
    ...
    resource_version: Optional[str] = Field(
        None, alias='resourceVersion', description='Specifies the target ResourceVersion'
    )
...
class StatusDetails(BaseModel):
    ...
    group: Optional[str] = Field(
        None, description='The group attribute of the resource associated with the status StatusReason.'
    )
    kind: Optional[str] = Field(
        None,
...
class ApiVersions(BaseModel):
    ...
    versions: List[str] = Field(..., description='versions are the api versions that are available.')
...
class Condition(BaseModel):
    ...
    reason: str = Field(
        ...,
        description="reason contains a programmatic identifier indicating the reason for the condition's last transition. Producers of specific condition generated may define expected values and meanings for this field, and whether the values are considered a guaranteed API. The value should be a CamelCase string. This field may not be empty.",
    )
    status: str = Field(..., description='status of the condition, one of True, False, Unknown.')
    type: str = Field(..., description='type of condition in CamelCase or in foo.example.com/CamelCase.')
...
class Status(BaseModel):
    ...
    code: Optional[int] = Field(None, description='Suggested HTTP return code for this status, 0 if not set.')
...
class WatchEvent(BaseModel):
    ...
    object: runtime.RawExtension = Field(
        ...,
        description='Object is:\n * If Type is Added or Modified: the new state of the object.\n * If Type is Deleted: the state of the object immediately before deletion.\n * If Type is Error: *Status is recommended; other generated may make sense\n   depending on context.',
    )
    type: str
