...
class ResourceAttributes(BaseModel):
    ...
    group: Optional[str] = Field(None, description='Group is the API Group of the Resource.  "*" means all.')
    ...
    resource: Optional[str] = Field(None, description='Resource is one of the existing resource generated.  "*" means all.')
    subresource: Optional[str] = Field(
        None, description='Subresource is one of the existing resource generated.  "" means none.'
    )
    verb: Optional[str] = Field(
        None,
        description='Verb is a kubernetes resource API verb, like: get, list, watch, create, update, delete, proxy.  "*" means all.',
    )
    version: Optional[str] = Field(None, description='Version is the API Version of the Resource.  "*" means all.')
...
class SubjectAccessReviewSpec(BaseModel):
    ...
    groups: Optional[List[str]] = Field(None, description="Groups is the groups you're testing for.")
    non_resource_attributes: Optional[NonResourceAttributes] = Field(
        None,
        alias='nonResourceAttributes',
        description='NonResourceAttributes describes information for a non-resource access request',
...
class SubjectAccessReviewStatus(BaseModel):
    ...
    allowed: bool = Field(..., description='Allowed is required. True if the action would be allowed, false otherwise.')
...
class LocalSubjectAccessReview(BaseModel):
    ...
    status: Optional[SubjectAccessReviewStatus] = Field(
        None, description='Status is filled in by the server and indicates whether the request is allowed or not'
    )
...
class SelfSubjectRulesReview(BaseModel):
    ...
    status: Optional[SubjectRulesReviewStatus] = Field(
        None, description='Status is filled in by the server and indicates the set of actions a user can perform.'
    )
...
class SubjectAccessReview(BaseModel):
    ...
    spec: SubjectAccessReviewSpec = Field(..., description='Spec holds information about the request being evaluated')
    status: Optional[SubjectAccessReviewStatus] = Field(
        None, description='Status is filled in by the server and indicates whether the request is allowed or not'
    )
