...
class StatefulSetPersistentVolumeClaimRetentionPolicy(BaseModel):
    ...
    when_deleted: Optional[str] = Field(
        None,
        alias='whenDeleted',
        description='WhenDeleted specifies what happens to PVCs created from StatefulSet VolumeClaimTemplates when the StatefulSet is deleted. The default policy of `Retain` causes PVCs to not be affected by StatefulSet deletion. The `Delete` policy causes those PVCs to be deleted.',
    )
    when_scaled: Optional[str] = Field(
        None,
        alias='whenScaled',
...
class DaemonSetStatus(BaseModel):
    ...
    conditions: Optional[List[DaemonSetCondition]] = Field(
        None, description="Represents the latest available observations of a DaemonSet's current state."
    )
...
class DeploymentCondition(BaseModel):
    ...
    last_update_time: Optional[v1.Time] = Field(
        None, alias='lastUpdateTime', description='The last time this condition was updated.'
    )
    message: Optional[str] = Field(
        None, description='A human readable message indicating details about the transition.'
    )
...
class DeploymentStatus(BaseModel):
    ...
    conditions: Optional[List[DeploymentCondition]] = Field(
        None, description="Represents the latest available observations of a deployment's current state."
    )
    observed_generation: Optional[int] = Field(
        None, alias='observedGeneration', description='The generation observed by the deployment controller.'
    )
...
class ReplicaSetStatus(BaseModel):
    ...
    conditions: Optional[List[ReplicaSetCondition]] = Field(
        None, description="Represents the latest available observations of a replica set's current state."
    )
...
class StatefulSetStatus(BaseModel):
    ...
    conditions: Optional[List[StatefulSetCondition]] = Field(
        None, description="Represents the latest available observations of a statefulset's current state."
    )
    ...
    replicas: int = Field(..., description='replicas is the number of Pods created by the StatefulSet controller.')
...
class ControllerRevision(BaseModel):
    ...
    revision: int = Field(..., description='Revision indicates the revision of the state represented by Data.')
...
class ControllerRevisionList(BaseModel):
    ...
    items: List[ControllerRevision] = Field(..., description='Items is the list of ControllerRevisions')
    kind: Optional[str] = Field(
        None,
        description='Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds',
    )
...
class DaemonSetUpdateStrategy(BaseModel):
    ...
    rolling_update: Optional[RollingUpdateDaemonSet] = Field(
        None, alias='rollingUpdate', description='Rolling update config params. Present only if type = "RollingUpdate".'
    )
...
class DaemonSetSpec(BaseModel):
    ...
    update_strategy: Optional[DaemonSetUpdateStrategy] = Field(
        None, alias='updateStrategy', description='An update strategy to replace existing DaemonSet pods with new pods.'
    )
...
class DeploymentSpec(BaseModel):
    ...
    strategy: Optional[DeploymentStrategy] = Field(
        None, description='The deployment strategy to use to replace existing pods with new ones.'
    )
    template: v1_1.PodTemplateSpec = Field(..., description='Template describes the pods that will be created.')
...
class StatefulSetSpec(BaseModel):
    ...
    persistent_volume_claim_retention_policy: Optional[StatefulSetPersistentVolumeClaimRetentionPolicy] = Field(
        None,
    ...
    pod_management_policy: Optional[PodManagementPolicy] = Field(
        None,
...
class Deployment(BaseModel):
    ...
    spec: Optional[DeploymentSpec] = Field(None, description='Specification of the desired behavior of the Deployment.')
    status: Optional[DeploymentStatus] = Field(None, description='Most recently observed status of the Deployment.')
