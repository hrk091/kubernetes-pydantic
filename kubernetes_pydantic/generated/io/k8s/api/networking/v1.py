...
class IngressStatus(BaseModel):
    ...
    load_balancer: Optional[v1.LoadBalancerStatus] = Field(
        None, alias='loadBalancer', description='LoadBalancer contains the current status of the load-balancer.'
    )
...
class HttpIngressRuleValue(BaseModel):
    ...
    paths: List[HttpIngressPath] = Field(..., description='A collection of paths that map requests to backends.')
...
class IngressSpec(BaseModel):
    ...
    default_backend: Optional[IngressBackend] = Field(
        None,
