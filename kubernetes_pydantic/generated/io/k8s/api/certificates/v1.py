...
class CertificateSigningRequestCondition(BaseModel):
    ...
    last_update_time: Optional[v1.Time] = Field(
        None, alias='lastUpdateTime', description='lastUpdateTime is the time of the last update to this condition'
    )
    message: Optional[str] = Field(
        None, description='message contains a human readable message with details about the request state'
    )
    reason: Optional[str] = Field(None, description='reason indicates a brief reason for the request state')
    status: str = Field(
        ...,
...
class CertificateSigningRequestStatus(BaseModel):
    ...
    conditions: Optional[List[CertificateSigningRequestCondition]] = Field(
        None, description='conditions applied to the request. Known conditions are "Approved", "Denied", and "Failed".'
    )
