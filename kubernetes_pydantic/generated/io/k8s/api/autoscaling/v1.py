...
class ScaleSpec(BaseModel):
    ...
    replicas: Optional[int] = Field(None, description='desired number of instances for the scaled object.')
...
class ScaleStatus(BaseModel):
    ...
    replicas: int = Field(..., description='actual number of observed instances of the scaled object.')
...
class HorizontalPodAutoscalerStatus(BaseModel):
    ...
    current_replicas: int = Field(
        ..., alias='currentReplicas', description='current number of replicas of pods managed by this autoscaler.'
    )
    desired_replicas: int = Field(
        ..., alias='desiredReplicas', description='desired number of replicas of pods managed by this autoscaler.'
    )
    ...
    observed_generation: Optional[int] = Field(
        None, alias='observedGeneration', description='most recent generation observed by this autoscaler.'
    )
...
class HorizontalPodAutoscalerList(BaseModel):
    ...
    items: List[HorizontalPodAutoscaler] = Field(..., description='list of horizontal pod autoscaler objects.')
    kind: Optional[str] = Field(
        None,
        description='Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds',
    )
