...
class ServiceReference(BaseModel):
    ...
    path: Optional[str] = Field(
        None, description='`path` is an optional URL path which will be sent in any request to this service.'
    )
...
class MutatingWebhook(BaseModel):
    ...
    client_config: WebhookClientConfig = Field(
        ..., alias='clientConfig', description='ClientConfig defines how to communicate with the hook. Required'
    )
...
class MutatingWebhookConfiguration(BaseModel):
    ...
    webhooks: Optional[List[MutatingWebhook]] = Field(
        None, description='Webhooks is a list of webhooks and the affected resources and operations.'
    )
...
class MutatingWebhookConfigurationList(BaseModel):
    ...
    items: List[MutatingWebhookConfiguration] = Field(..., description='List of MutatingWebhookConfiguration.')
    kind: Optional[str] = Field(
        None,
        description='Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds',
    )
...
class ValidatingWebhookConfigurationList(BaseModel):
    ...
    items: List[ValidatingWebhookConfiguration] = Field(..., description='List of ValidatingWebhookConfiguration.')
    kind: Optional[str] = Field(
        None,
        description='Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds',
    )
