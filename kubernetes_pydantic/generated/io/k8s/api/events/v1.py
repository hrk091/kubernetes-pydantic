...
class Event(BaseModel):
    ...
    type: Optional[str] = Field(
        None,
        description='type is the type of this event (Normal, Warning), new generated could be added in the future. It is machine-readable. This field cannot be empty for new Events.',
    )
