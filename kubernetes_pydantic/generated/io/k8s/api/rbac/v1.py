...
class PolicyRule(BaseModel):
    ...
    resources: Optional[List[str]] = Field(
        None, description="Resources is a list of resources this rule applies to. '*' represents all resources."
    )
...
class RoleRef(BaseModel):
    ...
    api_group: str = Field(..., alias='apiGroup', description='APIGroup is the group for the resource being referenced')
...
class ClusterRole(BaseModel):
    ...
    metadata: Optional[v1.ObjectMeta] = Field(None, description="Standard object's metadata.")
    rules: Optional[List[PolicyRule]] = Field(None, description='Rules holds all the PolicyRules for this ClusterRole')
...
class ClusterRoleBindingList(BaseModel):
    ...
    items: List[ClusterRoleBinding] = Field(..., description='Items is a list of ClusterRoleBindings')
    kind: Optional[str] = Field(
        None,
        description='Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds',
    )
    metadata: Optional[v1.ListMeta] = Field(None, description="Standard object's metadata.")
...
class Role(BaseModel):
    ...
    metadata: Optional[v1.ObjectMeta] = Field(None, description="Standard object's metadata.")
    rules: Optional[List[PolicyRule]] = Field(None, description='Rules holds all the PolicyRules for this Role')
