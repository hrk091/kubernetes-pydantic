...
class BoundObjectReference(BaseModel):
    ...
    kind: Optional[str] = Field(None, description="Kind of the referent. Valid kinds are 'Pod' and 'Secret'.")
...
class UserInfo(BaseModel):
    ...
    groups: Optional[List[str]] = Field(None, description='The names of groups this user is a part of.')
...
class TokenReviewStatus(BaseModel):
    ...
    error: Optional[str] = Field(None, description="Error indicates that the token couldn't be checked")
    user: Optional[UserInfo] = Field(None, description='User is the UserInfo associated with the provided token.')
...
class TokenRequest(BaseModel):
    ...
    spec: TokenRequestSpec = Field(..., description='Spec holds information about the request being evaluated')
    status: Optional[TokenRequestStatus] = Field(
        None, description='Status is filled in by the server and indicates whether the token can be authenticated.'
    )
...
class TokenReview(BaseModel):
    ...
    spec: TokenReviewSpec = Field(..., description='Spec holds information about the request being evaluated')
    status: Optional[TokenReviewStatus] = Field(
        None, description='Status is filled in by the server and indicates whether the request can be authenticated.'
    )
