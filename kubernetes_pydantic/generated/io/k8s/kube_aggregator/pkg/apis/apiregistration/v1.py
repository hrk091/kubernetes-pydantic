...
class ApiServiceStatus(BaseModel):
    ...
    conditions: Optional[List[ApiServiceCondition]] = Field(None, description='Current service state of apiService.')
...
class ServiceReference(BaseModel):
    ...
    namespace: Optional[str] = Field(None, description='Namespace is the namespace of the service')
...
class ApiServiceSpec(BaseModel):
    ...
    group: Optional[str] = Field(None, description='Group is the API group name this server hosts')
    ...
    version: Optional[str] = Field(None, description='Version is the API version this server hosts.  For example, "v1"')
...
class ApiService(BaseModel):
    ...
    spec: Optional[ApiServiceSpec] = Field(
        None, description='Spec contains information for locating and communicating with a server'
    )
